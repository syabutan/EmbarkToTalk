...
import { RecordAudio } from './recordaudio.service';
...
export class CheckSentence{
    ...
    // constructor(private recordAudio: RecordAudio){
    // }
    check(voiceText){
      this.voiceText = voiceText;
      this.checkAllSentences();
      return this.score;
    }
    ...
    checkAllSentences(){
      if(this.choiceOne !== ''){
          if(this.choiceTwo !==''){
            this.score =  Math.max(this.checkPercent(this.choiceOne,this.voiceText), this.checkPercent(this.choiceTwo,this.voiceText));
          }
          else {this.score = this.checkPercent(this.choiceOne,this.voiceText);}
        }
        else if (this.choiceTwo !== ''){
          this.checkPercent(this.choiceTwo,this.voiceText);
        }
    }
  ...
  updateSentences(choiceOne, choiceTwo, voiceText){
